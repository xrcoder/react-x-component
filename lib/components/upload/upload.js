...
function getXhrError(option, xhr) {
    // 构造一个错误对象，并返回
    var msg = _reactIntlUniversal2.default.get('Upload.error').d('\u4E0A\u4F20\u5931\u8D25') + ('\uFF1A' + option.url + ' ' + xhr.status);
...
exports.default = function (option) {
    ...
    xhr.ontimeout = function () {
        option.onError({ status: xhr.status, msg: _reactIntlUniversal2.default.get('Upload.timeout').d('请求超时') });
    };
