...
var _imageView = require('../../components/image-view');
...
var _default = function (_React$Component) {
    ...
    function _default() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                Object.keys(files).map(function (fileUid, index) {
                    switch (styleType) {
                        case 'preview':
                            return _this2.renderPreviewItem(files[fileUid], index);
                            break;
                        case 'previewWidthName':
                            return _this2.renderPreviewWithNameItem(files[fileUid], index);
                            break;
                        default:
                            return _this2.renderNormalItem(files[fileUid], index);
                            break;
                    }
                })
            );
