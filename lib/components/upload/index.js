...
var XUpload = function (_React$Component) {
    ...
    function XUpload() {
        ...
        var _this = _possibleConstructorReturn(this, (XUpload.__proto__ || Object.getPrototypeOf(XUpload)).call(this));
    ...
    _createClass(XUpload, [{
        ...
        value: function uploadFiles(files) {
            ...
            postList.map(function (item) {
                var file = item;
                file.uid = _this2.state.getUid.uid();
                _this2.upload(file, files);
            });
        }
    }, {
        key: 'upload',
        value: function upload(file, fileList) {
            ...
            new Promise(function (resolve) {
                ...
                _this3.uploadList[uid] = (0, _upload2.default)({
                    url: url,
                    filename: props.name,
                    file: file,
                    data: data,
