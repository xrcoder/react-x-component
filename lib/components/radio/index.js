    ...
    _createClass(XRadio, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: localStorage.getItem('direction') == 'right' ? 'x-radio-i18n' : 'x-radio' },
                this.props.radioList.map(function (item, index) {
                    if (_this2.props.checked === false || _this2.props.checked === true) {
                        return _react2.default.createElement(
                            'div',
                            { key: item.label + index, className: 'x-radio-li ' + (_this2.props.checked === true ? 'active-radio' : null) + ' ' + (item.disable == true ? 'radio-disable' : null), onClick: function onClick() {
                                    ...
                                    if (_this2.props.cancel == true) {
                                        if (_this2.props.checked === false) {
                                            ...
                                            _this2.props.onChange({ value: -1, label: item.label });
                                        }
                                    } else {
                                        _this2.props.onChange(item);
                                    }
                                } },
                            _this2.props.checked === true ? _react2.default.createElement(_icon2.default, { type: 'radio-selected' }) : _react2.default.createElement(_icon2.default, { type: 'radio' }),
                            item.label
                        );
                    } else {
                        return _react2.default.createElement(
