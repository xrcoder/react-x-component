...
var XTabs = function (_Component) {
    ...
    function XTabs(props) {
        _classCallCheck(this, XTabs);

        var _this = _possibleConstructorReturn(this, (XTabs.__proto__ || Object.getPrototypeOf(XTabs)).call(this, props));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.tabList.map(function (item, index) {
                        return _react2.default.createElement(
                            'div',
                            { key: item.label + index, className: 'x-tab-li ' + (item.value == _this2.state.activeTabValue ? 'active-tab' : null) + ' ' + (item.disable == true ? 'tab-disable' : null), onClick: function onClick(e) {
