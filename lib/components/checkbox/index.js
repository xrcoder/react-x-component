...
function Item(_ref) {
    ...
    var isSelected = selected.indexOf(data.value) > -1;

    return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('item', { selected: isSelected }), onClick: function onClick() {
                onSelected(data);
            } },
        _react2.default.createElement(
            'span',
            { className: 'icon' },
            isSelected ? _react2.default.createElement(_icon2.default, { name: 'check' }) : null
        ),
        _react2.default.createElement(
            'span',
            { className: 'name' },
...
function CheckBox(props) {
    ...
    return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('x-checkbox', className), style: style },
