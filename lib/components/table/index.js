...
var OrderArea = function OrderArea(props) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'order-box' },
        _react2.default.createElement('div', { title: _reactIntlUniversal2.default.get('Table.sortUp').d('\u5347\u5E8F'), className: isUp ? 'order-up selected' : 'order-up',
            onClick: upClick.bind(undefined) }),
        _react2.default.createElement('div', { title: _reactIntlUniversal2.default.get('Table.sortDown').d('\u964D\u5E8F'), className: isDown ? 'order-down selected' : 'order-down',
    ...
    return initDone && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _reactIntlUniversal2.default.get('Global.empty').d('\u6682\u65E0\u6570\u636E')
                                )
                            )
                        )
                    )
        ...
        !noPagination && _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _reactIntlUniversal2.default.get('Table.count', { count: count }).d('\u5171 ' + count + ' \u6761')
            ),
