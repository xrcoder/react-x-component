...
var XPagination = function (_Component) {
    ...
    _createClass(XPagination, [{
        ...
        value: function renderPagination() {
            ...
            if (count === 0 || count === null) {
                ...
                return _react2.default.createElement(
                    'div',
                    { className: 'x-pagination ' + size + ' ' + className },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _reactIntlUniversal2.default.get('Pagination.prevPage').d('\u4E0A\u4E00\u9875')
                        ),
                        ...
                        _react2.default.createElement(
                            ...
                            _reactIntlUniversal2.default.get('Pagination.nextPage').d('\u4E0B\u4E00\u9875'),
                    ...
                    this.state.showJumpPage && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            _reactIntlUniversal2.default.get('Pagination.jumpTo').d('\u8DF3\u81F3')
                        ),
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            _reactIntlUniversal2.default.get('Pagination.page').d('\u9875')
                        )
                    ),
                    this.props.showPageSize ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            _reactIntlUniversal2.default.get('Pagination.itemsPerPage').d('\u6761/\u9875')
                        )
                    ) : ''
                );
            }
        ...
        value: function render() {
            return this.state.initDone && this.renderPagination();
        }
    }]);
