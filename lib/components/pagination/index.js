    ...
    _createClass(XPagination, [{
        ...
        value: function onPageSizeChange(pageSize) {
            ...
            this.setState({
                ...
                _this3.props.onPageSizeChange(pageSize);
            });
        }
    }, {
        key: 'onPageJump',
        value: function onPageJump(pageIndex) {
            ...
            if (pageIndex !== "") {
                this.setState({
                    ...
                    _this4.props.onPageChange(index);
                });
            }
        }
    }, {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { className: (0, _classnames2.default)('prev', { disabled: this.state.currPage == 1 }),
                                onClick: function onClick() {
                                    if (_this5.state.currPage == 1) {
                                        return;
                                    }
                                    _this5.onCurrPageChange(_this5.state.currPage - 1);
                                } },
                        ...
                        _react2.default.createElement(
                            ...
                            { className: (0, _classnames2.default)('next', { disabled: this.state.currPage == totalPage }),
                                onClick: function onClick() {
                                    if (_this5.state.currPage == totalPage) {
                                        return;
                                    }
                                    _this5.onCurrPageChange(_this5.state.currPage + 1);
                                } },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_select2.default, {
                                ...
                                onChange: function onChange(res) {
                                    ...
                                    _this5.onPageSizeChange(pageSize);
                                } })
                        ),
                        _react2.default.createElement(
                            'span',
