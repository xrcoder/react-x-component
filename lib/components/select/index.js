    ...
    _createClass(XSelect, [{
        ...
        value: function render() {
            ...
            return this.state.initDone !== false && this.state.mode == 'multiple' ? _react2.default.createElement(
                'div',
                { className: (localStorage.getItem('direction') == 'right' ? 'x-select-i18n' : 'x-select') + ' ' + (this.state.showOptions ? 'x-select-clicked' : null) + '  x-select-clicked-multiple', ref: this.xSelect, onClick: function onClick(e) {
