...
var XSelect = function (_Component) {
    ...
    _createClass(XSelect, [{
        ...
        value: function render() {
            ...
            return this.state.initDone && this.state.mode == 'multiple' ? _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    'div',
                    { placeholder: _reactIntlUniversal2.default.get('Global.selectPlaceholder').d('\u8BF7\u9009\u62E9'), disabled: true, value: this.state.selected.label, className: 'x-select-title x-select-title-multiple ' + (this.props.disabled ? 'x-select-disabled' : null) },
                ...
                'div',
                { className: 'x-select x-select-content-height ' + (this.state.showOptions ? 'x-select-clicked' : null) + ' x-select-' + this.props.size, ref: this.xSelect, onClick: function onClick(e) {
                        if (_this3.props.disabled) {
                            return;
                        } else {
                            var showOptions = _this3.state.showOptions;
